...
public class Test1Test {
  ...
  public void test1() {
    ...
    driver.findElement(By.id("inputName")).sendKeys("FilipeA");
    driver.findElement(By.id("address")).sendKeys("123 Main St");
    driver.findElement(By.id("city")).sendKeys("Leiria");
    ...
    driver.findElement(By.id("nameOnCard")).sendKeys("Filipe Gonc");
    driver.findElement(By.cssSelector(".btn-primary")).click();
